      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden items-center gap-2 rounded-full border border-border bg-white px-3 py-2 text-sm font-semibold text-navy shadow-soft transition-colors hover:bg-accent sm:inline-flex"
          >
