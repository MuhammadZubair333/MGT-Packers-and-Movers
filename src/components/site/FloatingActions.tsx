...
export function FloatingActions() {
  return (
    <div className="fixed bottom-4 right-4 z-40 flex flex-col gap-2.5 sm:bottom-6 sm:right-6">
      <a
        href={waHref()}
        target="_blank"
        rel="noreferrer"
        aria-label="WhatsApp"
        className="grid h-13 w-13 place-items-center rounded-full bg-[oklch(0.55_0.17_145)] p-3 text-white shadow-glow-navy transition-transform hover:scale-105"
      >
