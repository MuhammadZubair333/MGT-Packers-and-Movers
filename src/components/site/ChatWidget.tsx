                ...
                {m.role === "assistant" ? (
                  <div className="flex max-w-[80%] flex-col gap-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1.5 self-start rounded-full bg-[#25D366] px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition-all hover:bg-[#20b858] hover:scale-[1.02]"
                    >
                      ...
                      For more details, chat on WhatsApp
                    </a>
                  </div>
                ) : (
